...
class EditarController{
    ...
    public function show($params) {
        ...
        $eventoData = $eventoModel->getOneById($id);
        ...
        $vEvento = new EditarView();
        $vEvento->show($evento, $id);  
    }
    ...
    public function form($params) {
        ...
        if (!isset($_SESSION['username'])) {
            ...
            if (empty($errors)) {
                $eventoModel = new EventoModel();
                $id = isset($_GET['id']) ? $_GET['id'] : null;
                $eventoModel->update($id, $frm_nombre, $frm_descripcion, $frm_inicio, $frm_fin, $frm_etiqueta);
