...
<head>
    ...
    <style>
        ...
        .ticket {
            width: 100%;
            max-height: 65mm;
            background-image: url('./img/<?php echo $evento->getImagen(); ?>');
...
<body>
    <div class="ticket">
        <div class="contenidoTicket">
            <div class="eventoLabel">CONCERT</div>
            <h1 class="nombreTour"><?php echo htmlspecialchars($evento->getNombre()); ?></h1>
            <div class="nombreArtista"><?php echo htmlspecialchars($evento->getArtista()); ?></div>
            ...
            <div class="fechaEvento">
                ...
                <table class="detalles" cellspacing="2mm" cellpadding="0">
                    <tr>
                        <td class="ubicacion"><?php echo htmlspecialchars($evento->getLugar()); ?></td>
        ...
        <div class="ticketInfo">
                ...
                <table class="tablaInfoEntrada" cellspacing="2mm" cellpadding="0">
                    <tr>
                        <td>
                            ...
                            <div class="infoValor"><?php echo htmlspecialchars($entrada->getAsientoNumero()); ?></div>
                        </td>
                        <td>
                            <div class="infoLabel">Fila</div>
                            <div class="infoValor"><?php echo htmlspecialchars($entrada->getFila()); ?></div>
                        </td>
                        <td>
                            <div class="infoLabel">Sección</div>
                            <div class="infoValor"><?php echo htmlspecialchars($entrada->getSeccion()); ?></div>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="barcode">
                ...
                <div class="numeroBarcode">
                    <?php echo htmlspecialchars($entrada->getCodigoReferencia()); ?>
                </div>
            </div>
